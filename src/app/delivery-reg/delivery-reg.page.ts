...
@Component({
  selector: 'app-delivery-reg',
  templateUrl: './delivery-reg.page.html',
  styleUrls: ['./delivery-reg.page.scss'],
  standalone: false,
})
export class DeliveryRegPage implements OnInit {
  tipoUsuario: string = '';
  ...
  constructor(private router: Router, private usuarioService: UsuarioService, private toastCtrl: ToastController) { }
